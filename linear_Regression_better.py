...
A = f1_score(data_stroke.tail(int(len(data)*(q/100))), X, average='weighted')
B = precision_score(data_stroke.tail(int(len(data)*(q/100))), X, average='weighted')
C = recall_score(data_stroke.tail(int(len(data)*(q/100))), X, average='weighted', zero_division=1)
